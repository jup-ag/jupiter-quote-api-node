...
export class DefaultApi extends runtime.BaseAPI {
    ...
    async quoteGetRaw(requestParameters: QuoteGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<QuoteResponse>> {
        ...
        if (requestParameters.amount === '' || requestParameters.amount === undefined) {
            throw new runtime.RequiredError('amount','Required parameter requestParameters.amount was undefined when calling quoteGet.');
        }
